<template>
	<main class="space-y-3">
		...
		<p>
			...
			<NuxtLink href="https://speed.14cloud.cn" target="_blank" external>14Cloud</NuxtLink> and
			<NuxtLink href="https://nitro.build" target="_blank" external>Nitro</NuxtLink> community.
		</p>
		<p>
			Also a newbie to the coding world. Now I mainly create my own things in my Lab "Sliver
			Complex".
		</p>
		...
		<p>
			Currently spending my free time gaming, my favorite games are Minecraft, Arcaea, Phigros and
			Rotaeno.
		</p>
	</main>
</template>
