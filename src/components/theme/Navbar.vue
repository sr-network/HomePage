<template>
    <nav class="navbar" role="navigation" aria-label="main navigation">
        <div class="navbar-brand grid justify-items-center md:justify-items-left">
            <a class="navbar-item" href="/">
                <img src="https://library.gxres.net/images/icons/favicon.webp" width="28" height="28" alt="Site favicon">
                <div class="ml-2 font-medium">Ou's Intro</div>
            </a>
        </div>
